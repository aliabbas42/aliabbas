...
\033[1;91m☞ Auther     : MIST3R_FYT3R_9LI_H3R3
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update ALI_ABBAS Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' ALI_ABBAS WhatsApp Group')
